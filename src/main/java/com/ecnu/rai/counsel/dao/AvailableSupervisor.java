...
@AllArgsConstructor
@Builder
@ApiModel(description = "用户返回的督导信息")
public class AvailableSupervisor {
    ...
    public AvailableSupervisor(Supervisor supervisor){
        ...
        this.qualification = supervisor.getQualification();
        this.qualificationCode = supervisor.getQualificationCode();
    }
}
